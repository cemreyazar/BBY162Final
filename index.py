...
class Katalogum:
    def __init__(self,anasayfa):
        ...
        anasayfa.title("jemre")
        anasayfa.configure(background="white")

        self.foto = Image.open("library.jpeg")
        self.tkimage = ImageTk.PhotoImage(self.foto)
        self.resim = Label(root, image=self.tkimage)
        self.resim.grid()

        self.kitap_ekle = Button(anasayfa, text="Kitap Ekle", bg="black",fg="white",cursor="star",font="bold",command = self.kitap_ekle)
        self.kitap_ekle.grid(row="1")

        self.kitapları_listele = Button(anasayfa, text="Kitapları Listele",bg="black",fg="white",cursor="star",font="bold", command=self.kitaplari_listele)
        self.kitapları_listele.grid(row="2")

        self.kitap_sil = Button(anasayfa, text="Kitap Sil", bg="black",fg="white",cursor="star",font="bold",command=self.kitap_sil)
        self.kitap_sil.grid(row="3")

        self.kitap_ara = Button(anasayfa, text="Kitap Ara", bg="black",fg="white",cursor="star",font="bold",command=self.kitap_ara)
        self.kitap_ara.grid(row="4")

        self.cikis = Button(anasayfa, text ="Kapat", command=exit, fg="black", bg="white",cursor="star")
    ...
    def kitap_ekle(self):
        ...
        self.kaydet = Button(pencere1, text= "Kaydet",command=self.kitap_kaydet, fg="black", bg="white")
        self.kaydet.grid(column=1, row=9)

        self.cıkıs = Button(pencere1 ,text = "Kapat", command=pencere1.destroy, fg="black", bg="white",cursor="star")
        self.cıkıs.grid(column=3, row=9)
        Label(pencere1,bg="black",fg="white", text='Kitap Adı: ').grid(column=1, row=3)
        Label(pencere1,bg="black",fg="white", text='Yazar Adı: ').grid(column=1, row=4)
        Label(pencere1,bg="black",fg="white", text='Kitabın Türü: ').grid(column=1, row=5)
        Label(pencere1,bg="black",fg="white", text='ISBN :').grid(column=1, row=6)
        Label(pencere1,bg="black",fg="white", text='Yayınevi : ').grid(column=1, row=7)
        Label(pencere1,bg="black",fg="white", text='Yayın Yılı :').grid(column=1, row=8)
    def kitap_kaydet(self):
        ...
        for i in kayit_sis:
            dosya.write(i)
        dosya.close()
        tkinter.messagebox.showinfo('Mesaj', 'Kitap Bilgileri Başarıyla Eklendi.')
    ...
    def kitaplari_listele(self):
        ...
        kitap_liste = Label(pencerex, text=data,fg="white", bg="black")
        kitap_liste.pack()

        self.cıkıs = Button(pencerex ,text = "Kapat", command=pencerex.destroy, fg="black", bg="white",cursor="star")
        self.cıkıs.pack()
    ...
    def kitap_sil(self):
        ...
        tkinter.messagebox.showinfo('Mesaj', 'Kitap Silme Butonu Henüz Hazır Değil.\nYakında Kullanıma Sunulacaktır.')
    ...
    def kitap_ara(self):
        ...
        self.labelKitap=Label(pencere4,bg="black",fg="white",text="Kitap İsmi ile Arama ")
        ...
        self.butonKitap=Button(pencere4,text="onay",bg="black",fg="white",cursor="star",font="bold",command=kitap)
        self.butonKitap.grid(row=0,column=2)

        self.labelYazar=Label(pencere4,bg="black",fg="white",text="Yazar İsimi ile Arama ")
        ...
        self.butonYazar = Button(pencere4, text="onay",bg="black",fg="white",cursor="star",font="bold",command=yazar)
        self.butonYazar.grid(row=1,column=2)

        self.labelKitapTürü=Label(pencere4,bg="black",fg="white",text="Kitap Türü ile Arama ")
        ...
        self.butonKitapTürü = Button(pencere4, text="onay",bg="black",fg="white",cursor="star",font="bold",command=kitapTürü)
        self.butonKitapTürü.grid(row=2,column=2)

        self.labelIsbn=Label(pencere4,bg="black",fg="white",text="ISBN ile Arama ")
        ...
        self.butonIsbn = Button(pencere4, text="onay",bg="black",fg="white",cursor="star",font="bold",command=ısbn)
        self.butonIsbn.grid(row=3,column=2)

        self.labelYayınevi=Label(pencere4,bg="black",fg="white",text="Yayınevi ile Arama ")
        ...
        self.butonYayınevi = Button(pencere4, text="onay",bg="black",fg="white",cursor="star",font="bold",command=yayınevi)
        self.butonYayınevi.grid(row=4,column=2)

        self.labelYayınyılı=Label(pencere4,bg="black",fg="white",text="Yayın Yılı ile Arama ")
        ...
        self.butonYayınyılı = Button(pencere4, text="onay",bg="black",fg="white",cursor="star",font="bold",command=Yayınyılı)
